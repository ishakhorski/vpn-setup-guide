...
2.  **IP or IP CIDR**: Конкретные IP-адреса или их диапазоны.
    *   `1.1.1.1`
    *   `geoip:cloudflare` — все IP-адреса, принадлежащие Cloudflare.
3.  **Process**: Маршрутизация конкретных программ (только для Windows).
...
В папке с приложением v2rayN есть папка **bin**. В ней находятся файл **geosite.dat**. Это сборник сайтов, которые объеденены в группы.
<br/> К примеру если нужно добавить telegram как правило, нужно поиском в файле пройтись по всем совпадениям **telegram.org**. Если ваш сайт есть в файле, то у него всегда есть категрия. Она всегда пишется заглавными буквами, к примеру `TELEGRAM`. 
...
<div class="w-full flex justify-center">
    <img src="../../../images/exampleroute.png" alt="Пример правила маршрутиризации" style="max-height: 600px;" />
</div>
