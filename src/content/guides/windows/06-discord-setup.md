...
1. Скачайте два файла: <a href="https://github.com/runetfreedom/discord-voice-proxy/releases/latest/download/DWrite.dll" target="_blank">DWrite.dll</a> и <a href="https://github.com/runetfreedom/discord-voice-proxy/releases/latest/download/force-proxy.dll" target="_blank">force-proxy.dll</a>
2. Перейдите в папку Discord: откройте проводник и вставьте в адресную строку `%LocalAppData%\Discord`
3. Найдите самую свежую папку `app-` (например, `app-1.0.9231`) и перетащите в неё оба скачанных файла
